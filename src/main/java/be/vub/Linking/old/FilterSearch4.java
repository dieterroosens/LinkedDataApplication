...
@WebServlet(name = "FilterSearch4Servlet", urlPatterns = {"/filtersearch4","/filterSearch4"})
public class FilterSearch4 extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger( FilterSearch4.class );
    ...
    private void scripts(PrintWriter out){
        out.println("<script>" +
                "function runProcessorValues(srcElement, childElement){\n" +
                "\n" +
        ...
        out.println("<script>function showHideFilterElements(element, button) {\n" +
                ...
                "  runProcessorValues(this, element+'values')\n"+
                ...
                " } else{document.getElementById(element+'values').style.display = \"block\";} }" +
